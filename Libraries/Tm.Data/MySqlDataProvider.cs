...
using Tm.Data.Migrations;

namespace Tm.Data
{
    public class MySqlTmDataProvider : BaseDataProvider, ITmDataProvider
    {
        #region Fields
        ...
        protected void ExecuteSqlScriptFromFile(ITmFileProvider fileProvider, string filePath)
        {
        ...
        public void InitializeDatabase()
        {
            ...
            ExecuteSqlScriptFromFile(fileProvider, TmDataDefaults.MySQLStoredProceduresFilePath);
        }
        ...
        public virtual string BuildConnectionString(ITmConnectionStringInfo nopConnectionString)
        {
            if (nopConnectionString is null)
                throw new ArgumentNullException(nameof(nopConnectionString));

            if (nopConnectionString.IntegratedSecurity)
                throw new TmException("Data provider supports connection only with login and password");
