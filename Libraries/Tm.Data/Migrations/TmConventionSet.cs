...
namespace Tm.Data.Migrations
{
    ...
    /// </summary>
    public class TmConventionSet : IConventionSet
    {
        #region Ctor

        public TmConventionSet(ITmDataProvider dataProvider)
            : this(new DefaultConventionSet(), new TmForeignKeyConvention(dataProvider), new TmIndexConvention(dataProvider))
        {
        }

        public TmConventionSet(IConventionSet innerConventionSet, TmForeignKeyConvention foreignKeyConvention, TmIndexConvention indexConvention)
        {
