...
namespace Tm.Core.Configuration
{
    ...
    public partial class TmConfig
    {
        ...
        /// <summary>
        /// Gets or sets PATH for fleet images
        /// </summary>
        public string FleetImagesFolderPath { get; set; }

        /// <summary>
        /// Gets or sets PATH for currency icon
        /// </summary>
        public string CurrencyIconImagesFolderPath { get;set; }
        /// <summary>
        /// Gets or sets PATH for attachment
        /// </summary>
        public string AttachmentFolderPath { get;set; }
        /// <summary>
        /// Gets or sets PATH for manager attachment
        /// </summary>
        public string ManagerAttachmentFolderPath { get;set; }
        /// <summary>
        /// Gets or sets PATH for manager closed attachment 
        /// </summary>
         public string ManagerClosedAttachmentFolderPath { get;set; }
        /// <summary>
        /// Gets or sets PATH for change request attachment 
        /// </summary>
        public string CRAttachmentFolderPath { get;set; }
        /// <summary>
        /// Gets or sets Customer attachment 
        /// </summary>
		public string CustomerAttachmentFolderPath { get; set; }

        /// <summary>
        /// Gets or sets Order Attachment 
        /// </summary>
        public string OrderAttachmentFolderPath { get; set; }
        ...
        /// <summary>
        /// Get or set Project Attachments
        /// </summary>
        public string ProjectAttachmentFolderPath { get; set; }
    }
}