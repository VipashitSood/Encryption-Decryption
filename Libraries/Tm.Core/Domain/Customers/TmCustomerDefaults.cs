namespace Tm.Core.Domain.Customers
{
	...
	/// </summary>
	public static partial class TmCustomerDefaults
	{
		...
		/// <summary>
		/// Gets a system name of 'HeadOfSales' customer role
		/// </summary>
		public static string HeadOfSalesRoleName => "HeadOfSales";

		/// <summary>
		/// Gets a system name of 'HeadOfBusiness' customer role
		/// </summary>
		public static string HeadOfBusinessRoleName => "HeadOfBusiness";

		/// <summary>
		/// Gets a system name of 'SalesManager' customer role
		/// </summary>
		public static string SalesManagerRoleName => "SalesManager";

		/// <summary>
		/// Gets a system name of 'BrandDirector' customer role
		/// </summary>
		public static string BrandDirectorRoleName => "BrandDirector";

		/// <summary>
		/// Gets a system name of 'AreaManager' customer role
		/// </summary>
		public static string AreaManagerRoleName => "AreaManager";

		/// <summary>
		/// Gets a system name of 'NationalManager' customer role
		/// </summary>
		public static string NationalManagerRoleName => "NationalManager";

		/// <summary>
		/// Gets a system name of 'FleetManager' customer role
		/// </summary>
		public static string FleetManagerRoleName => "FleetManager";

		/// <summary>
		/// Gets a system name of 'PPAdmin' customer role
		/// </summary>
		public static string PPAdminRoleName => "PPAdmin";
