...
namespace Tm.Core.Domain.Customers
{
    ...
    public static class CustomerExtensions
    {
        ...
        public static bool IsSearchEngineAccount(this Customer customer)
        {
            ...
            var result = customer.SystemName.Equals(TmCustomerDefaults.SearchEngineCustomerName, StringComparison.InvariantCultureIgnoreCase);
        ...
        public static bool IsBackgroundTaskAccount(this Customer customer)
        {
            ...
            var result = customer.SystemName.Equals(TmCustomerDefaults.BackgroundTaskCustomerName, StringComparison.InvariantCultureIgnoreCase);
