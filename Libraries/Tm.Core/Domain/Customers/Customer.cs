...
namespace Tm.Core.Domain.Customers
{
    ...
    public partial class Customer : BaseEntity
    {
        ...
        ///// <summary>
        ///// Gets or sets the customer access token
        ///// </summary>
        //public string CustomerAccessToken { get; set; }

        ///// <summary>
        ///// Gets or sets the customer refresh token
        ///// </summary>
        //public string CustomerRefreshToken { get; set; }

        ///// <summary>
        ///// Gets or sets the password recovery token attribute
        ///// </summary>
        //public Guid? PasswordRecoveryTokenAttribute { get; set; }

        ///// <summary>
        ///// Gets or sets the password recovery token generated attribute
        ///// </summary>
        //public DateTime? PasswordRecoveryTokenDateGeneratedAttribute { get; set; }
    }
}