...
namespace Tm.Core.Infrastructure
{
    ...
    /// </summary>
    public class TmFileProvider : PhysicalFileProvider, ITmFileProvider
    {
        /// <summary>
        /// Initializes a new instance of a TmFileProvider
        /// </summary>
        /// <param name="webHostEnvironment">Hosting environment</param>
        public TmFileProvider(IWebHostEnvironment webHostEnvironment)
