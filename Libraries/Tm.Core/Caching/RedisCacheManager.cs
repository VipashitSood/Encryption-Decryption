...
namespace Tm.Core.Caching
{
    ...
    public partial class RedisCacheManager : IStaticCacheManager
    {
        ...
        private readonly TmConfig _config;
        ...
        protected virtual IEnumerable<RedisKey> GetKeys(EndPoint endPoint, string prefix = null)
        {
            ...
            keys = keys.Where(key => !key.ToString().Equals(TmDataProtectionDefaults.RedisDataProtectionKey,
        ...
        {
            //we should always persist the data protection key list
            if (key.Key.Equals(TmDataProtectionDefaults.RedisDataProtectionKey, StringComparison.OrdinalIgnoreCase))
                return;
