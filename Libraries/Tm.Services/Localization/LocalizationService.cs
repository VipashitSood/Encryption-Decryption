...
namespace Tm.Services.Localization
{
    /// <summary>
    ...
    public partial class LocalizationService : ILocalizationService
    {
        ...
        {
            var key = _cacheKeyService.PrepareKeyForDefaultCache(TmLocalizationDefaults.LocaleStringResourcesAllCacheKey, languageId);
            ...
            if (!loadPublicLocales.HasValue || _staticCacheManager.IsSet(key))
            {
                ...
                _staticCacheManager.Remove(_cacheKeyService.PrepareKeyForDefaultCache(TmLocalizationDefaults.LocaleStringResourcesAllPublicCacheKey, languageId));
                _staticCacheManager.Remove(_cacheKeyService.PrepareKeyForDefaultCache(TmLocalizationDefaults.LocaleStringResourcesAllAdminCacheKey, languageId));
            ...
            key = _cacheKeyService.PrepareKeyForDefaultCache(
                    loadPublicLocales.Value ? TmLocalizationDefaults.LocaleStringResourcesAllPublicCacheKey : TmLocalizationDefaults.LocaleStringResourcesAllAdminCacheKey,
                    languageId);
            ...
            return _staticCacheManager.Get(key, () =>
            {
                ...
                var query = from l in _lsrRepository.Table
                            ...
                            where l.LanguageId == languageId
                            select l;
                query = loadPublicLocales.Value ? query.Where(r => !r.ResourceName.StartsWith(TmLocalizationDefaults.AdminLocaleStringResourcesPrefix)) : query.Where(r => r.ResourceName.StartsWith(TmLocalizationDefaults.AdminLocaleStringResourcesPrefix));
                return ResourceValuesToDictionary(query);
            });
        }
            ...
            bool logIfNotFound = true, string defaultValue = "", bool returnEmptyIfNotFound = false)
        {
            ...
            if (_localizationSettings.LoadAllLocaleRecordsOnStartup)
            {
                ...
                var resources = GetAllResourceValues(languageId, !resourceKey.StartsWith(TmLocalizationDefaults.AdminLocaleStringResourcesPrefix, StringComparison.InvariantCultureIgnoreCase));
            ...
            {
                //gradual loading
                var key = _cacheKeyService.PrepareKeyForDefaultCache(TmLocalizationDefaults.LocaleStringResourcesByResourceNameCacheKey
        ...
        public virtual string ExportResourcesToXml(Language language)
        {
            ...
            using (var xmlWriter = new XmlTextWriter(stream, Encoding.UTF8))
            {
                ...
                xmlWriter.WriteAttributeString("SupportedVersion", TmVersion.CurrentVersion);
        ...
        public virtual void ImportResourcesFromXml(Language language, StreamReader xmlStreamReader, bool updateExistingResources = true)
        {
            ...
            //clear cache
            _staticCacheManager.RemoveByPrefix(TmLocalizationDefaults.LocaleStringResourcesPrefixCacheKey);
        }
        ...
        public virtual string GetLocalizedEnum<TEnum>(TEnum enumValue, int? languageId = null) where TEnum : struct
        {
            ...
            //localized value
            var resourceName = $"{TmLocalizationDefaults.EnumLocaleStringResourcesPrefix}{typeof(TEnum)}.{enumValue}";
        ...
        public virtual string GetLocalizedPermissionName(PermissionRecord permissionRecord, int? languageId = null)
        {
            ...
            //localized value
            var resourceName = $"{TmLocalizationDefaults.PermissionLocaleStringResourcesPrefix}{permissionRecord.SystemName}";
            var result = GetResource(resourceName, languageId ?? _workContext.WorkingLanguage.Id, false, string.Empty, true);
