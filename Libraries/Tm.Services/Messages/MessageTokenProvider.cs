    ...
    public partial class MessageTokenProvider : IMessageTokenProvider
    {
        ...
        protected Dictionary<string, IEnumerable<string>> AllowedTokens
        {
            get
            {
                ...
                //forecasting tokens for retailer
                _allowedTokens.Add(TokenGroupNames.ForecastingRetailer, new[]
                {
                    "%ForecastingOpenDayForRetailer%",
                    "%ForecastingCloseDayForRetailer%",
                    "%ForecastingOpenTimeForRetailer%",
                    "%ForecastingCloseTimeForRetailer%",
                    "%ForecastingOpenDateForRetailer%",
                    "%ForecastingCloseDateForRetailer%",
                    "%ForecastingMonthForRetailer%",
                    "%ForecastReminder.forecastingType%",
                    "%ForecastReminder.MessageForRetailer%",
                });

                //forecasting tokens for area manager
                _allowedTokens.Add(TokenGroupNames.ForecastingAreaManager, new[]
                {
                    "%ForecastingOpenDayForAreaManager%",
                    "%ForecastingCloseDayForAreaManager%",
                    "%ForecastingOpenTimeForAreaManager%",
                    "%ForecastingCloseTimeForAreaManager%",
                    "%ForecastingOpenDateForAreaManager%",
                    "%ForecastingCloseDateForAreaManager%",
                    "%ForecastingMonthForAreaManager%",
                    "%ForecastReminder.forecastingType%",
                    "%ForecastReminder.MessageForAreaManager%",
                });
        ...
        public virtual void AddCustomerTokens(IList<Token> tokens, Customer customer)
        {
            ...
            tokens.Add(new Token("Customer.FirstName", _genericAttributeService.GetAttribute<string>(customer, TmCustomerDefaults.FirstNameAttribute)));
            tokens.Add(new Token("Customer.LastName", _genericAttributeService.GetAttribute<string>(customer, TmCustomerDefaults.LastNameAttribute)));
            tokens.Add(new Token("Customer.VatNumber", _genericAttributeService.GetAttribute<string>(customer, TmCustomerDefaults.VatNumberAttribute)));
            //tokens.Add(new Token("Customer.VatNumberStatus", ((VatNumberStatus)_genericAttributeService.GetAttribute<int>(customer, TmCustomerDefaults.VatNumberStatusIdAttribute)).ToString()));
            ...
            var passwordRecoveryUrl = RouteUrl(routeName: "PasswordRecoveryConfirm", routeValues: new { token = _genericAttributeService.GetAttribute<string>(customer, TmCustomerDefaults.PasswordRecoveryTokenAttribute), guid = customer.CustomerGuid });
            var accountActivationUrl = RouteUrl(routeName: "AccountActivation", routeValues: new { token = _genericAttributeService.GetAttribute<string>(customer, TmCustomerDefaults.AccountActivationTokenAttribute), guid = customer.CustomerGuid });
            var emailRevalidationUrl = RouteUrl(routeName: "EmailRevalidation", routeValues: new { token = _genericAttributeService.GetAttribute<string>(customer, TmCustomerDefaults.EmailRevalidationTokenAttribute), guid = customer.CustomerGuid });
        ...
        //    var vendorAttributesXml = _genericAttributeService.GetAttribute<string>(vendor, TmVendorDefaults.VendorAttributes);
