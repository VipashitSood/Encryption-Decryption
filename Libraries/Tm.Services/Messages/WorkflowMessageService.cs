...
namespace Tm.Services.Messages
{
    ...
    public partial class WorkflowMessageService : IWorkflowMessageService
    {
        ...
        /// </summary>
        /// <param name="messageTemplateSystemName"></param>
        /// <param name="toEmail"></param>
        /// <param name="toName"></param>
        /// <param name="languageId"></param>
        /// <returns></returns>
        public virtual IList<int> SendEmailToCustomer(string messageTemplateSystemName, string toEmail, string toName, int languageId)
        {
            var messageTemplates = GetActiveMessageTemplates(messageTemplateSystemName, 0);
            if (!messageTemplates.Any())
                return new List<int>();
            ...
            return messageTemplates.Select(messageTemplate =>
            {
                ...
                return SendNotification(messageTemplate, emailAccount, languageId,new List<Token>(), toEmail, toName, fromEmail: emailAccount.Email, fromName: emailAccount.DisplayName);
            }).ToList();
        }
