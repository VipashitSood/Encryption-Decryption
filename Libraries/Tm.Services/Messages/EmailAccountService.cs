    ...
    public partial class EmailAccountService : IEmailAccountService
    {
        ...
        public virtual void DeleteEmailAccount(EmailAccount emailAccount)
        {
            ...
            if (GetAllEmailAccounts().Count == 1)
                throw new TmException("You cannot delete this email account. At least one account is required.");
        ...
        public virtual IList<EmailAccount> GetAllEmailAccounts()
        {
            ...
            var emailAccounts = query.ToCachedList(_cacheKeyService.PrepareKeyForDefaultCache(TmMessageDefaults.EmailAccountsAllCacheKey));
