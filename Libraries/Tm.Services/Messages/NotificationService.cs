...
namespace Tm.Services.Messages
{
    ...
    public partial class NotificationService : INotificationService
    {
        ...
        protected virtual void PrepareTempData(NotifyType type, string message, bool encode = true)
        {
            ...
            var messages = tempData.ContainsKey(TmMessageDefaults.NotificationListKey)
                ? JsonConvert.DeserializeObject<IList<NotifyData>>(tempData[TmMessageDefaults.NotificationListKey].ToString())
                : new List<NotifyData>();
            ...
            tempData[TmMessageDefaults.NotificationListKey] = JsonConvert.SerializeObject(messages);
        }
