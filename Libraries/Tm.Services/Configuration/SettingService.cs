...
namespace Tm.Services.Configuration
{
    /// <summary>
    /// Setting manager
    /// </summary>
    public partial class SettingService : ISettingService
    {
        ...
        protected virtual IDictionary<string, IList<Setting>> GetAllSettingsDictionary()
        {
            ...
            return _staticCacheManager.Get(TmConfigurationDefaults.SettingsAllAsDictionaryCacheKey, () =>
            {
        ...
        public virtual IList<Setting> GetAllSettings()
        {
            ...
            //we can not use ICacheKeyService because it'll cause circular references.
            //that's why we use the default cache time
            var settings = query.ToCachedList(TmConfigurationDefaults.SettingsAllCacheKey);
        ...
        {
            _staticCacheManager.RemoveByPrefix(TmConfigurationDefaults.SettingsPrefixCacheKey);
        }
