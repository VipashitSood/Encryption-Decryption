...
namespace Tm.Services.Helpers
{
    ...
    public partial class UserAgentHelper : IUserAgentHelper
    {
        ...
        protected virtual BrowscapXmlHelper GetBrowscapXmlHelper()
        {
            ...
            //no database created
            if (string.IsNullOrEmpty(_TmConfig.UserAgentStringsPath))
                return null;
            ...
            lock (_locker)
            {
                ...
                var userAgentStringsPath = _fileProvider.MapPath(_TmConfig.UserAgentStringsPath);
                var crawlerOnlyUserAgentStringsPath = !string.IsNullOrEmpty(_TmConfig.CrawlerOnlyUserAgentStringsPath)
                    ? _fileProvider.MapPath(_TmConfig.CrawlerOnlyUserAgentStringsPath)
                    : string.Empty;
