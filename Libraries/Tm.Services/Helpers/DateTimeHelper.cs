...
namespace Tm.Services.Helpers
{
    ...
    public partial class DateTimeHelper : IDateTimeHelper
    {
        ...
        public virtual TimeZoneInfo GetCustomerTimeZone(Customer customer)
        {
            ...
            if (customer != null)
                timeZoneId = _genericAttributeService.GetAttribute<string>(customer, TmCustomerDefaults.TimeZoneIdAttribute);
        ...
        public virtual TimeZoneInfo CurrentTimeZone
        {
            ...
            set
            {
                ...
                _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer,
                    TmCustomerDefaults.TimeZoneIdAttribute, timeZoneId);
            }
        }
