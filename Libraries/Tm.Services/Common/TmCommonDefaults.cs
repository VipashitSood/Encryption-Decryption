...
namespace Tm.Services.Common
{
    ...
    /// </summary>
    public static partial class TmCommonDefaults
    {
        /// <summary>
        /// Gets a request path to the keep alive URL
        /// </summary>
        public static string KeepAlivePath => "api/customer/keepalive";
        ...
        /// {2} : language code
        /// </remarks>
        public static string TmCopyrightWarningPath => "site-warnings?url={0}&local={1}&language={2}";
        ...
        /// {4} : language code
        /// </remarks>
        public static string TmNewsRssPath => "nopcommerce-news-rss?version={0}&localhost={1}&hideAdvertisements={2}&storeUrl={3}&language={4}";
        ...
        /// {4} : language code
        /// </remarks>
        public static string TmInstallationCompletedPath => "installation-completed?version={0}&local={1}&email={2}&url={3}&language={4}";
        ...
        /// {0} : language code
        /// </remarks>
        public static string TmExtensionsCategoriesPath => "extensions-feed?getCategories=1&language={0}";
        ...
        /// {0} : language code
        /// </remarks>
        public static string TmExtensionsVersionsPath => "extensions-feed?getVersions=1&language={0}";
        ...
        /// {6} : language code
        /// </remarks>
        public static string TmExtensionsPath => "extensions-feed?category={0}&version={1}&price={2}&searchTerm={3}&pageIndex={4}&pageSize={5}&language={6}";
