...
namespace Tm.Services.Security
{
    ...
    public partial class PermissionService : IPermissionService
    {
        ...
        {
            var key = _cacheKeyService.PrepareKeyForDefaultCache(TmSecurityDefaults.PermissionsAllByCustomerRoleIdCacheKey, customerRoleId);
        ...
        public virtual bool Authorize(string permissionRecordSystemName, int customerRoleId)
        {
            ...
            var key = _cacheKeyService.PrepareKeyForDefaultCache(TmSecurityDefaults.PermissionsAllowedCacheKey, permissionRecordSystemName, customerRoleId);
