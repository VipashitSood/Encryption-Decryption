...
namespace Tm.Services.Customers
{
    ...
    public partial class CustomerAttributeService : ICustomerAttributeService
    {
        ...
        public virtual IList<CustomerAttribute> GetAllCustomerAttributes()
        {
            ...
            return query.ToCachedList(_cacheKeyService.PrepareKeyForDefaultCache(TmCustomerServicesDefaults.CustomerAttributesAllCacheKey));
        }
        ...
        {
            var key = _cacheKeyService.PrepareKeyForDefaultCache(TmCustomerServicesDefaults.CustomerAttributeValuesAllCacheKey, customerAttributeId);
