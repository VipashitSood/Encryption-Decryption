...
namespace Tm.Services.Customers
{
    /// <summary>
    /// Customer service
    /// </summary>
    public partial class CustomerService : ICustomerService
    {
            ...
            int pageIndex = 0, int pageSize = int.MaxValue, bool getOnlyTotalCount = false)
        {
            ...
            if (!string.IsNullOrWhiteSpace(firstName))
            {
                query = query
                    ...
                    .Where(z => z.Attribute.KeyGroup == nameof(Customer) &&
                                z.Attribute.Key == TmCustomerDefaults.FirstNameAttribute &&
            ...
            if (!string.IsNullOrWhiteSpace(lastName))
            {
                query = query
                    .Join(_gaRepository.Table, x => x.Id, y => y.EntityId, (x, y) => new { Customer = x, Attribute = y })
                    .Where(z => z.Attribute.KeyGroup == nameof(Customer) &&
                                z.Attribute.Key == TmCustomerDefaults.LastNameAttribute &&
            ...
            if (dayOfBirth > 0 && monthOfBirth > 0)
            {
                ...
                query = query
                    .Join(_gaRepository.Table, x => x.Id, y => y.EntityId, (x, y) => new { Customer = x, Attribute = y })
                    .Where(z => z.Attribute.KeyGroup == nameof(Customer) &&
                                z.Attribute.Key == TmCustomerDefaults.DateOfBirthAttribute &&
            ...
            if (!string.IsNullOrWhiteSpace(company))
            {
                query = query
                    .Join(_gaRepository.Table, x => x.Id, y => y.EntityId, (x, y) => new { Customer = x, Attribute = y })
                    .Where(z => z.Attribute.KeyGroup == nameof(Customer) &&
                                z.Attribute.Key == TmCustomerDefaults.CompanyAttribute &&
            ...
            if (!string.IsNullOrWhiteSpace(phone))
            {
                query = query
                    .Join(_gaRepository.Table, x => x.Id, y => y.EntityId, (x, y) => new { Customer = x, Attribute = y })
                    .Where(z => z.Attribute.KeyGroup == nameof(Customer) &&
                                z.Attribute.Key == TmCustomerDefaults.PhoneAttribute &&
            ...
            if (!string.IsNullOrWhiteSpace(zipPostalCode))
            {
                query = query
                    .Join(_gaRepository.Table, x => x.Id, y => y.EntityId, (x, y) => new { Customer = x, Attribute = y })
                    .Where(z => z.Attribute.KeyGroup == nameof(Customer) &&
                                z.Attribute.Key == TmCustomerDefaults.ZipPostalCodeAttribute &&
        ...
        public virtual void DeleteCustomer(Customer customer)
        {
            ...
            if (customer.IsSystemAccount)
                throw new TmException($"System customer account ({customer.SystemName}) could not be deleted");
        ...
        {
            var backgroundTaskUser = GetCustomerBySystemName(TmCustomerDefaults.BackgroundTaskCustomerName);
            ...
            if(backgroundTaskUser is null)
            {
                ...
                backgroundTaskUser = new Customer
                {
                    ...
                    SystemName = TmCustomerDefaults.BackgroundTaskCustomerName,
                ...
                var guestRole = GetCustomerRoleBySystemName(TmCustomerDefaults.GuestsRoleName);

                if(guestRole is null)
                    throw new TmException("'Guests' role could not be loaded");
        ...
        {
            var searchEngineUser = GetCustomerBySystemName(TmCustomerDefaults.SearchEngineCustomerName);
            ...
            if(searchEngineUser is null)
            {
                ...
                searchEngineUser = new Customer
                {
                    ...
                    Active = true,
                    IsSystemAccount = true,
                    SystemName = TmCustomerDefaults.SearchEngineCustomerName,
                    CreatedOnUtc = DateTime.UtcNow,
                    LastActivityDateUtc = DateTime.UtcNow,
                    RegisteredInStoreId = _storeContext.CurrentStore.Id
                };
            ...
            bool clearPaymentMethod = true)
        {
            ...
            if (clearCouponCodes)
            {
                _genericAttributeService.SaveAttribute<string>(customer, TmCustomerDefaults.DiscountCouponCodeAttribute, null);
                _genericAttributeService.SaveAttribute<string>(customer, TmCustomerDefaults.GiftCardCouponCodesAttribute, null);
            }

            //clear checkout attributes
            if (clearCheckoutAttributes)
            {
                _genericAttributeService.SaveAttribute<string>(customer, TmCustomerDefaults.CheckoutAttributes, null, storeId);
            }

            ////clear reward points flag
            //if (clearRewardPoints)
            //{
            //    _genericAttributeService.SaveAttribute(customer, TmCustomerDefaults.UseRewardPointsDuringCheckoutAttribute, false, storeId);
            //}

            ////clear selected shipping method
            //if (clearShippingMethod)
            //{
            //    _genericAttributeService.SaveAttribute<ShippingOption>(customer, TmCustomerDefaults.SelectedShippingOptionAttribute, null, storeId);
            //    _genericAttributeService.SaveAttribute<ShippingOption>(customer, TmCustomerDefaults.OfferedShippingOptionsAttribute, null, storeId);
            //    _genericAttributeService.SaveAttribute<PickupPoint>(customer, TmCustomerDefaults.SelectedPickupPointAttribute, null, storeId);
            //}

            ////clear selected payment method
            //if (clearPaymentMethod)
            //{
            //    _genericAttributeService.SaveAttribute<string>(customer, TmCustomerDefaults.SelectedPaymentMethodAttribute, null, storeId);
            //}
        ...
        public virtual string GetCustomerFullName(Customer customer)
        {
            ...
            var firstName = _genericAttributeService.GetAttribute<string>(customer, TmCustomerDefaults.FirstNameAttribute);
            var lastName = _genericAttributeService.GetAttribute<string>(customer, TmCustomerDefaults.LastNameAttribute);
        ...
        public virtual string FormatUsername(Customer customer, bool stripTooLong = false, int maxLength = 0)
        {
            ...
            switch (_customerSettings.CustomerNameFormat)
            {
                ...
                case CustomerNameFormat.ShowFirstName:
                    result = _genericAttributeService.GetAttribute<string>(customer, TmCustomerDefaults.FirstNameAttribute);
                    break;
                default:
                    break;
            }
        ...
        public virtual string[] ParseAppliedDiscountCouponCodes(Customer customer)
        {
            ...
            var existingCouponCodes = _genericAttributeService.GetAttribute<string>(customer, TmCustomerDefaults.DiscountCouponCodeAttribute);
        ...
        public virtual void ApplyDiscountCouponCode(Customer customer, string couponCode)
        {
            ...
            //apply new value
            _genericAttributeService.SaveAttribute(customer, TmCustomerDefaults.DiscountCouponCodeAttribute, result);
        }
        ...
        public virtual string[] ParseAppliedGiftCardCouponCodes(Customer customer)
        {
            ...
            var existingCouponCodes = _genericAttributeService.GetAttribute<string>(customer, TmCustomerDefaults.GiftCardCouponCodesAttribute);
        ...
        public virtual void ApplyGiftCardCouponCode(Customer customer, string couponCode)
        {
            ...
            //apply new value
            _genericAttributeService.SaveAttribute(customer, TmCustomerDefaults.GiftCardCouponCodesAttribute, result);
        }
        ...
        public virtual void DeleteCustomerRole(CustomerRole customerRole)
        {
            ...
            if (customerRole.IsSystemRole)
                throw new TmException("System role could not be deleted");
        ...
        public virtual CustomerRole GetCustomerRoleBySystemName(string systemName)
        {
            ...
            var key = _cacheKeyService.PrepareKeyForDefaultCache(TmCustomerServicesDefaults.CustomerRolesBySystemNameCacheKey, systemName);
        ...
        public virtual int[] GetCustomerRoleIds(Customer customer, bool showHidden = false)
        {
            ...
            var key = _cacheKeyService.PrepareKeyForShortTermCache(TmCustomerServicesDefaults.CustomerRoleIdsCacheKey, customer, showHidden);
        ...
        public virtual IList<CustomerRole> GetCustomerRoles(Customer customer, bool showHidden = false)
        {
            ...
            var key = _cacheKeyService.PrepareKeyForShortTermCache(TmCustomerServicesDefaults.CustomerRolesCacheKey, customer, showHidden);
        ...
        {
            var key = _cacheKeyService.PrepareKeyForDefaultCache(TmCustomerServicesDefaults.CustomerRolesAllCacheKey, showHidden);
        ...
        {
            return IsInCustomerRole(customer, TmCustomerDefaults.AdministratorsRoleName, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, TmCustomerDefaults.ForumModeratorsRoleName, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, TmCustomerDefaults.RegisteredRoleName, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, TmCustomerDefaults.GuestsRoleName, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, TmCustomerDefaults.VendorsRoleName, onlyActiveCustomerRoles);
        }
        ...
        public virtual bool IsPasswordRecoveryTokenValid(Customer customer, string token)
        {
            ...
            var cPrt = _genericAttributeService.GetAttribute<string>(customer, TmCustomerDefaults.PasswordRecoveryTokenAttribute);
        ...
        public virtual bool IsPasswordRecoveryLinkExpired(Customer customer)
        {
            ...
            var geneatedDate = _genericAttributeService.GetAttribute<DateTime?>(customer, TmCustomerDefaults.PasswordRecoveryTokenDateGeneratedAttribute);
        ...
        public virtual bool PasswordIsExpired(Customer customer)
        {
            ...
            var cacheKey = _cacheKeyService.PrepareKeyForShortTermCache(TmCustomerServicesDefaults.CustomerPasswordLifetimeCacheKey, customer);
        ...
        //    var key = _cacheKeyService.PrepareKeyForShortTermCache(TmCustomerServicesDefaults.CustomerAddressesByCustomerIdCacheKey, customerId);
        ...
        //    var key = _cacheKeyService.PrepareKeyForShortTermCache(TmCustomerServicesDefaults.CustomerAddressCacheKeyCacheKey, customerId, addressId);
