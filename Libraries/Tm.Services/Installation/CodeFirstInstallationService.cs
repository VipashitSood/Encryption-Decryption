...
//using Tm.Services.News;

namespace Tm.Services.Installation
{
    /// <summary>
    ...
    public partial class CodeFirstInstallationService : IInstallationService
    {
        ...
        private readonly ITmDataProvider _dataProvider;
        private readonly IGenericAttributeService _genericAttributeService;
        private readonly ITmFileProvider _fileProvider;
        ...
        {
            return _fileProvider.GetAbsolutePath(TmInstallationDefaults.SampleImagesPath);
        }
        ...
        protected virtual void InstallLocaleResources()
        {
            ...
            //save resources
            var directoryPath = _fileProvider.MapPath(TmInstallationDefaults.LocalizationResourcesPath);
            var pattern = $"*.{TmInstallationDefaults.LocalizationResourcesFileExtension}";
        ...
        protected virtual void InstallSampleCustomers()
        {
            var crRegistered = _customerRoleRepository.Table.FirstOrDefault(customerRole =>
                customerRole.SystemName == TmCustomerDefaults.RegisteredRoleName);
            ...
            //_genericAttributeService.SaveAttribute(secondUser, TmCustomerDefaults.FirstNameAttribute, defaultSecondUserAddress.FirstName);
            //_genericAttributeService.SaveAttribute(secondUser, TmCustomerDefaults.LastNameAttribute, defaultSecondUserAddress.LastName);
            ...
            //set default customer name
            //_genericAttributeService.SaveAttribute(thirdUser, TmCustomerDefaults.FirstNameAttribute, defaultThirdUserAddress.FirstName);
            //_genericAttributeService.SaveAttribute(thirdUser, TmCustomerDefaults.LastNameAttribute, defaultThirdUserAddress.LastName);
            ...
            //set default customer name
            //_genericAttributeService.SaveAttribute(fourthUser, TmCustomerDefaults.FirstNameAttribute, defaultFourthUserAddress.FirstName);
            //_genericAttributeService.SaveAttribute(fourthUser, TmCustomerDefaults.LastNameAttribute, defaultFourthUserAddress.LastName);
            ...
            ////set default customer name
            //_genericAttributeService.SaveAttribute(fifthUser, TmCustomerDefaults.FirstNameAttribute,
            //    defaultFifthUserAddress.FirstName);
            //_genericAttributeService.SaveAttribute(fifthUser, TmCustomerDefaults.LastNameAttribute,
            ...
            //set default customer name
            //_genericAttributeService.SaveAttribute(sixthUser, TmCustomerDefaults.FirstNameAttribute, defaultSixthUserAddress.FirstName);
            //_genericAttributeService.SaveAttribute(sixthUser, TmCustomerDefaults.LastNameAttribute, defaultSixthUserAddress.LastName);
        ...
        protected virtual void InstallCustomersAndUsers(string defaultUserEmail, string defaultUserPassword)
        {
            var crAdministrators = new CustomerRole
            {
                ...
                Active = true,
                IsSystemRole = true,
                SystemName = TmCustomerDefaults.AdministratorsRoleName
            };
            var crForumModerators = new CustomerRole
            {
                ...
                Active = true,
                IsSystemRole = true,
                SystemName = TmCustomerDefaults.ForumModeratorsRoleName
            };
            var crRegistered = new CustomerRole
            {
                ...
                Active = true,
                IsSystemRole = true,
                SystemName = TmCustomerDefaults.RegisteredRoleName
            };
            var crGuests = new CustomerRole
            {
                ...
                Active = true,
                IsSystemRole = true,
                SystemName = TmCustomerDefaults.GuestsRoleName
            };
            var crVendors = new CustomerRole
            {
                ...
                Active = true,
                IsSystemRole = true,
                SystemName = TmCustomerDefaults.VendorsRoleName
            };
            ...
            //set default customer name
            _genericAttributeService.SaveAttribute(adminUser, TmCustomerDefaults.FirstNameAttribute, "John");
            _genericAttributeService.SaveAttribute(adminUser, TmCustomerDefaults.LastNameAttribute, "Smith");

            //set hashed admin password
            var customerRegistrationService = EngineContext.Current.Resolve<ICustomerRegistrationService>();
            customerRegistrationService.ChangePassword(new ChangePasswordRequest(defaultUserEmail, false,
                 PasswordFormat.Hashed, defaultUserPassword, null, TmCustomerServicesDefaults.DefaultHashedPasswordFormat));
        ...
        protected virtual void InstallSettings()
        {
            ...
            settingService.SaveSetting(new CommonSettings
            {
                ...
                SupportPreviousTmcommerceVersions = true,
                ...
                RestartTimeout = TmCommonDefaults.RestartTimeout
            });
            ...
            settingService.SaveSetting(new CustomerSettings
            {
                ...
                HashedPasswordFormat = TmCustomerServicesDefaults.DefaultHashedPasswordFormat,
                PasswordMinLength = 6,
            ...
            settingService.SaveSetting(new CachingSettings
            {
                ...
                DefaultCacheTime = TmCachingDefaults.CacheTime,
        ...
        protected virtual void InstallScheduleTasks()
        {
            var tasks = new List<ScheduleTask>
            {
                new ScheduleTask
                {
                    Name = "Send emails",
                    Seconds = 60,
                    Type = "Tm.Services.Messages.QueuedMessagesSendTask, Tm.Services",
                    Enabled = true,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    Name = "Keep alive",
                    Seconds = 300,
                    Type = "Tm.Services.Common.KeepAliveTask, Tm.Services",
                    Enabled = true,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    Name = "Delete guests",
                    Seconds = 600,
                    Type = "Tm.Services.Customers.DeleteGuestsTask, Tm.Services",
                    Enabled = true,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    Name = "Clear cache",
                    Seconds = 600,
                    Type = "Tm.Services.Caching.ClearCacheTask, Tm.Services",
                    Enabled = false,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    ...
                    //60 minutes
                    Seconds = 3600,
                    Type = "Tm.Services.Logging.ClearLogTask, Tm.Services",
                    Enabled = false,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    ...
                    //60 minutes
                    Seconds = 3600,
                    Type = "Tm.Services.Directory.UpdateExchangeRateTask, Tm.Services",
                    Enabled = true,
                    StopOnError = false
                }
            };
