...
namespace API.Infrastructure.Mapper.Extensions
{
    ...
    public static class MappingExtensions
    {
        ...
        public static TModel ToModel<TModel>(this BaseEntity entity) where TModel : BaseTmEntityModel
        {
            if (entity == null)
        ...
        public static TModel ToModel<TEntity, TModel>(this TEntity entity, TModel model) 
            where TEntity : BaseEntity where TModel : BaseTmEntityModel
        {
            if (entity == null)
                throw new ArgumentNullException(nameof(entity));
        ...
        public static TEntity ToEntity<TEntity>(this BaseTmEntityModel model) where TEntity : BaseEntity
        {
            if (model == null)
                throw new ArgumentNullException(nameof(model));
        ...
        /// <param name="destination">Destination object to map into</param>
        /// <returns>Mapped destination object, same instance as the passed destination object</returns>
        public static TDestination MapProperties<TSource, TDestination>(this TSource source, TDestination destination)
        {
            if (source == null)
        ...
        /// <returns>Mapped model</returns>
        public static TModel ToSettingsModel<TModel>(this ISettings settings) where TModel : BaseTmModel, ISettingsModel
        {
            if (settings == null)
        ...
        public static TSettings ToSettings<TSettings, TModel>(this TModel model, TSettings settings)
            where TSettings : class, ISettings where TModel : BaseTmModel, ISettingsModel
        {
            if (model == null)
                throw new ArgumentNullException(nameof(model));
