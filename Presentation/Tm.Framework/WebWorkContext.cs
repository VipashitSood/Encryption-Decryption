...
namespace Tm.Framework
{
    ...
    public partial class WebWorkContext : IWorkContext
    {
        ...
        {
            var cookieName = $"{TmCookieDefaults.Prefix}{TmCookieDefaults.CustomerCookie}";
        ...
        public virtual Customer CurrentCustomer
        {
            get
            {
                ...
                if (_httpContextAccessor.HttpContext == null ||
                    _httpContextAccessor.HttpContext.Request.Path.Equals(new PathString($"/{TmTaskDefaults.ScheduleTaskPath}"), StringComparison.InvariantCultureIgnoreCase))
                {
                ...
                if (customer != null && !customer.Deleted && customer.Active && !customer.RequireReLogin)
                {
                    ...
                    var impersonatedCustomerId = _genericAttributeService
                        .GetAttribute<int?>(customer, TmCustomerDefaults.ImpersonatedCustomerIdAttribute);
        ...
        public virtual Language WorkingLanguage
        {
            get
            {
                ...
                if (detectedLanguage == null && _localizationSettings.AutomaticallyDetectLanguage)
                {
                    ...
                    var alreadyDetected = _genericAttributeService.GetAttribute<bool>(CurrentCustomer,
                        TmCustomerDefaults.LanguageAutomaticallyDetectedAttribute, _storeContext.CurrentStore.Id);
                    ...
                    if (!alreadyDetected)
                    {
                        ...
                        if (detectedLanguage != null)
                        {
                            ...
                            _genericAttributeService.SaveAttribute(CurrentCustomer,
                                TmCustomerDefaults.LanguageAutomaticallyDetectedAttribute, true, _storeContext.CurrentStore.Id);
                        }
                    }
                }
                ...
                if (detectedLanguage != null)
                {
                    ...
                    var currentLanguageId = _genericAttributeService.GetAttribute<int>(CurrentCustomer,
                        TmCustomerDefaults.LanguageIdAttribute, _storeContext.CurrentStore.Id);

                    //save the detected language identifier if it differs from the current one
                    if (detectedLanguage.Id != currentLanguageId)
                    {
                        _genericAttributeService.SaveAttribute(CurrentCustomer,
                            TmCustomerDefaults.LanguageIdAttribute, detectedLanguage.Id, _storeContext.CurrentStore.Id);
                    }
                }
                ...
                var customerLanguage = allStoreLanguages.FirstOrDefault(language => language.Id == _storeContext.CurrentStore.DefaultLanguageId);
            ...
            set
            {
                ...
                //and save it
                _genericAttributeService.SaveAttribute(CurrentCustomer,
                    TmCustomerDefaults.LanguageIdAttribute, languageId, _storeContext.CurrentStore.Id);
        ...
        //            TmCustomerDefaults.CurrencyIdAttribute, _storeContext.CurrentStore.Id);
        ...
        //        //and save it
        //        _genericAttributeService.SaveAttribute(CurrentCustomer,
        //            TmCustomerDefaults.CurrencyIdAttribute, currencyId, _storeContext.CurrentStore.Id);
        ...
        //                TmCustomerDefaults.TaxDisplayTypeIdAttribute, _storeContext.CurrentStore.Id);
        ...
        //        //save passed value
        //        _genericAttributeService.SaveAttribute(CurrentCustomer,
        //            TmCustomerDefaults.TaxDisplayTypeIdAttribute, (int)value, _storeContext.CurrentStore.Id);
