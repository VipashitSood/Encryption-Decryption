...
namespace Tm.Framework.TagHelpers.Admin
{
    ...
    public class TmTabsTagHelper : TagHelper
    {
        ...
        public TmTabsTagHelper(IHtmlHelper htmlHelper)
        {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //create context item
            var tabContext = new List<TmTabContextItem>();
            context.Items.Add(typeof(TmTabsTagHelper), tabContext);
    ...
    public class TmTabTagHelper : TagHelper
    {
        ...
        /// </summary>
        /// <param name="htmlHelper">HTML helper</param>
        public TmTabTagHelper(IHtmlHelper htmlHelper)
        {
            _htmlHelper = htmlHelper;
        }
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //add to context
            var tabContext = (List<TmTabContextItem>)context.Items[typeof(TmTabsTagHelper)];
            tabContext.Add(new TmTabContextItem()
            {
