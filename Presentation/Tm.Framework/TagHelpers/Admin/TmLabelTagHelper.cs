...
namespace Tm.Framework.TagHelpers.Admin
{
    ...
    public class TmLabelTagHelper : TagHelper
    {
        ...
        public TmLabelTagHelper(IHtmlGenerator generator, IWorkContext workContext, ILocalizationService localizationService)
        {
            Generator = generator;
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (tagBuilder != null)
            {
                ...
                //add hint
                if (For.Metadata.AdditionalValues.TryGetValue("TmResourceDisplayNameAttribute", out object value))
                {
                    var resourceDisplayName = value as TmResourceDisplayNameAttribute;
