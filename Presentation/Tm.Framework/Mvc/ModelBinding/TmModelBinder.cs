...
{
    /// <summary>
    /// Represents model binder for the binding models inherited from the BaseTmModel
    /// </summary>
    public class TmModelBinder : ComplexTypeModelBinder
    {
        #region Ctor
        ...
        public TmModelBinder(IDictionary<ModelMetadata, IModelBinder> propertyBinders, ILoggerFactory loggerFactory)
        ...
        protected override object CreateModel(ModelBindingContext bindingContext)
        {
            ...
            if (model is BaseTmModel)
                (model as BaseTmModel).BindModel(bindingContext);
            ...
            ModelMetadata propertyMetadata, ModelBindingResult bindingResult)
        {
            ...
            if (bindingContext.Model is BaseTmModel && !string.IsNullOrEmpty(valueAsString))
            {
