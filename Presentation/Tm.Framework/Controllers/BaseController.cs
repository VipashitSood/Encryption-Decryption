...
using Tm.Framework.Mvc.Filters;
using Tm.Framework.UI;

namespace Tm.Framework.Controllers
{
    /// <summary>
    /// Base controller
    /// </summary>
    ...
    public abstract class BaseController : Controller
    {
        ...
        public virtual void SaveSelectedPanelName(string tabName, bool persistForTheNextRequest = true)
        {
            ...
            //"GetSelectedPanelName" method of \Tm.Framework\Extensions\HtmlExtensions.cs
        ...
        {
            //keep this method synchronized with
            //"GetSelectedTabName" method of \Tm.Framework\Extensions\HtmlExtensions.cs
            if (string.IsNullOrEmpty(tabName))
            {
        ...
        /// </remarks>
        [NonAction]
        public JsonResult Json<T>(BasePagedListModel<T> model) where T : BaseTmModel
        {
            return Json(new
            {
                draw = model.Draw,
